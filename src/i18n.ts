...
export const I18N = {
  ...
  be: {
    ...
    refreshed: "Абноўлена",
    active_poll_badge: "Ідзе апытанне",
    v_eat: "Буду есці",
    v_no: "Не буду есці",
    v_abs: "Адсутнічаю",
    v_eat_s: "Ем",
...
export const STUDENT_NAME_TRANSLATIONS: Record<string, { ru: string; be: string }> = {
  ...
  "пациенок дима": { ru: "Пациенок Дима", be: "Пацыенак Дзіма" },
  ...
  "сагдияна акрамова": { ru: "Сагдияна Акрамова", be: "Сагдзіяна Акрамава" },
  "артем дубовик": { ru: "Артем Дубовик", be: "Арцём Дубовік" },
  "артём дубовик": { ru: "Артем Дубовик", be: "Арцём Дубовік" },
  "влад дятлов": { ru: "Влад Дятлов", be: "Улад Дзятлаў" },
  "ксюша еремеева": { ru: "Ксюша Еремеева", be: "Ксюша Ерамеева" },
  "алина зайцева": { ru: "Алина Зайцева", be: "Аліна Зайцава" },
  "влад комар": { ru: "Влад Комар", be: "Улад Камар" },
  "стеша овсяник": { ru: "Стеша Овсяник", be: "Сцеша Аўсянік" },
  "дима пациенок": { ru: "Дима Пациенок", be: "Дзіма Пацыенак" },
  "арина перевозникова": { ru: "Арина Перевозникова", be: "Арына Перавознікава" },
  "витя самойлов": { ru: "Витя Самойлов", be: "Віця Самойлаў" },
  "алёна цмыг": { ru: "Алёна Цмыг", be: "Алёна Цмыг" },
  "алена цмыг": { ru: "Алёна Цмыг", be: "Алёна Цмыг" },
  "яна цмыг": { ru: "Яна Цмыг", be: "Яна Цмыг" },
  "вика щербич": { ru: "Вика Щербич", be: "Віка Шчэрбіч" },
  "вика щигельская": { ru: "Вика Щигельская", be: "Віка Шчыгельская" },
  "александрович дмитрий": { ru: "Александрович Дмитрий", be: "Аляксандравіч Дзмітрый" },

  // Reverse translations (BE -> RU / BE)
  "акрамава сагдзіяна": { ru: "Акрамова Сагдияна", be: "Акрамава Сагдзіяна" },
  "сагдзіяна акрамава": { ru: "Сагдияна Акрамова", be: "Сагдзіяна Акрамава" },
  "дубовік арцём": { ru: "Дубовик Артем", be: "Дубовік Арцём" },
  "арцём дубовік": { ru: "Артем Дубовик", be: "Арцём Дубовік" },
  "дзятлаў улад": { ru: "Дятлов Влад", be: "Дзятлаў Улад" },
  "улад дзятлаў": { ru: "Влад Дятлов", be: "Улад Дзятлаў" },
  "ерамеева ксюша": { ru: "Еремеева Ксюша", be: "Ерамеева Ксюша" },
  "ксюша ерамеева": { ru: "Ксюша Еремеева", be: "Ксюша Ерамеева" },
  "зайцава аліна": { ru: "Зайцева Алина", be: "Зайцава Аліна" },
  "аліна зайцава": { ru: "Алина Зайцева", be: "Аліна Зайцава" },
  "камар улад": { ru: "Комар Влад", be: "Камар Улад" },
  "улад камар": { ru: "Влад Комар", be: "Улад Камар" },
  "аўсянік сцеша": { ru: "Овсяник Стеша", be: "Аўсянік Сцеша" },
  "сцеша аўсянік": { ru: "Стеша Овсяник", be: "Сцеша Аўсянік" },
  "пацыенак дзіма": { ru: "Пациенок Дима", be: "Пацыенак Дзіма" },
  "дзіма пацыенак": { ru: "Дима Пациенок", be: "Дзіма Пацыенак" },
  "пацыёнак дзіма": { ru: "Пациенок Дима", be: "Пацыенак Дзіма" },
  "дзіма пацыёнак": { ru: "Дима Пациенок", be: "Дзіма Пацыенак" },
  "перавознікава арына": { ru: "Перевозникова Арина", be: "Перавознікава Арына" },
  "арына перавознікава": { ru: "Арина Перевозникова", be: "Арына Перавознікава" },
  "самойлаў віця": { ru: "Самойлов Витя", be: "Самойлаў Віця" },
  "віця самойлаў": { ru: "Витя Самойлов", be: "Віця Самойлаў" },
  "шчэрбіч віка": { ru: "Щербич Вика", be: "Шчэрбіч Віка" },
  "віка шчэрбіч": { ru: "Вика Щербич", be: "Віка Шчэрбіч" },
  "шчыгельская віка": { ru: "Щигельская Вика", be: "Шчыгельская Віка" },
  "віка шчыгельская": { ru: "Вика Щигельская", be: "Віка Шчыгельская" },
  "дзмітрый аляксандравіч": { ru: "Дмитрий Александрович", be: "Дзмітрый Аляксандравіч" },
  "аляксандравіч дзмітрый": { ru: "Александрович Дмитрий", be: "Аляксандравіч Дзмітрый" },

  // Single Last Names
  "акрамова": { ru: "Акрамова", be: "Акрамава" },
  "акрамава": { ru: "Акрамова", be: "Акрамава" },
  "дубовик": { ru: "Дубовик", be: "Дубовік" },
  "дубовік": { ru: "Дубовик", be: "Дубовік" },
  "дятлов": { ru: "Дятлов", be: "Дзятлаў" },
  "дзятлаў": { ru: "Дятлов", be: "Дзятлаў" },
  "еремеева": { ru: "Еремеева", be: "Ерамеева" },
  "ерамеева": { ru: "Еремеева", be: "Ерамеева" },
  "зайцева": { ru: "Зайцева", be: "Зайцава" },
  "зайцава": { ru: "Зайцева", be: "Зайцава" },
  "комар": { ru: "Комар", be: "Камар" },
  "камар": { ru: "Комар", be: "Камар" },
  "овсяник": { ru: "Овсяник", be: "Аўсянік" },
  "аўсянік": { ru: "Овсяник", be: "Аўсянік" },
  "пациенок": { ru: "Пациенок", be: "Пацыенак" },
  "пацыенак": { ru: "Пациенок", be: "Пацыенак" },
  "пацыёнак": { ru: "Пациенок", be: "Пацыенак" },
  "перевозникова": { ru: "Перевозникова", be: "Перавознікава" },
  "перавознікава": { ru: "Перевозникова", be: "Перавознікава" },
  "самойлов": { ru: "Самойлов", be: "Самойлаў" },
  "самойлаў": { ru: "Самойлов", be: "Самойлаў" },
  "цмыг": { ru: "Цмыг", be: "Цмыг" },
  "щербич": { ru: "Щербич", be: "Шчэрбіч" },
  "шчэрбіч": { ru: "Щербич", be: "Шчэрбіч" },
  "щигельская": { ru: "Щигельская", be: "Шчыгельская" },
  "шчыгельская": { ru: "Щигельская", be: "Шчыгельская" },

  // Single First Names
  "сагдияна": { ru: "Сагдияна", be: "Сагдзіяна" },
  "сагдзіяна": { ru: "Сагдияна", be: "Сагдзіяна" },
  "артем": { ru: "Артем", be: "Арцём" },
  "артём": { ru: "Артем", be: "Арцём" },
  "арцём": { ru: "Артем", be: "Арцём" },
  "влад": { ru: "Влад", be: "Улад" },
  "улад": { ru: "Влад", be: "Улад" },
  "дима": { ru: "Дима", be: "Дзіма" },
  "дзіма": { ru: "Дима", be: "Дзіма" },
  "арина": { ru: "Арина", be: "Арына" },
  "арына": { ru: "Арина", be: "Арына" },
  "витя": { ru: "Витя", be: "Віця" },
  "віця": { ru: "Витя", be: "Віця" },
  "стеша": { ru: "Стеша", be: "Сцеша" },
  "сцеша": { ru: "Стеша", be: "Сцеша" },
  "дмитрий": { ru: "Дмитрий", be: "Дзмітрый" },
  "дзмітрый": { ru: "Дмитрий", be: "Дзмітрый" },
  "александрович": { ru: "Александрович", be: "Аляксандравіч" },
  "аляксандравіч": { ru: "Александрович", be: "Аляксандравіч" }
};
...
export function getStudentDisplayName(raw: any, lang: Language = 'ru'): string {
  ...
  if (typeof raw === 'object') {
    if (lang === 'be') {
      if (raw.nameBe) {
        return String(raw.nameBe)
          .replace(/Пацыёнак/g, 'Пацыенак')
          .replace(/пацыёнак/g, 'пацыенак')
          .trim();
      }
      return getStudentDisplayName(raw.name || raw.nameRu, 'be');
    } else {
  ...
  // If string contains comma-separated names e.g. "Акрамова Сагдияна, Акрамава Сагдзіяна"
  if (str.includes(',')) {
    const parts = str.split(',').map(s => s.trim()).filter(Boolean);
    if (parts.length >= 2) {
      const part1 = parts[0];
      const part2 = parts[1];
      // Check which part has Belarusian characters
      const part2IsBe = /[ўі’'–—]|\bдз|\bдж/i.test(part2);
      if (part2IsBe) {
        return lang === 'be' ? getStudentDisplayName(part2, 'be') : getStudentDisplayName(part1, 'ru');
      } else {
        return lang === 'be' ? getStudentDisplayName(part1, 'be') : getStudentDisplayName(part2, 'ru');
      }
    }
  }

  // Normalize spelling for Pacienok in Belarusian
  if (lang === 'be') {
    str = str.replace(/Пацыёнак/g, 'Пацыенак').replace(/пацыёнак/g, 'пацыенак');
  }
